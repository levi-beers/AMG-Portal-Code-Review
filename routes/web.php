...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('/showdata', 'DashboardController@show');
    Route::get('/filtertable/{id}', 'DashboardController@showfilter');
    ...
    Route::get('content-tool', 'ContentToolController@index')->name('content-tool');

    Route::post('content-tool/search', 'ContentToolController@search')->name('content-tool.search');

    Route::get('content-tool/scrape', 'ContentToolController@scrape')->name('content-tool.scrape');


    /**
     * Content Sites
     */
    //Route::get('contentsites', 'ContentSiteController@index')->name('contentsites');
    Route::resource('contentsites', ContentSitesController::class);
    Route::resource('blockeddomains', BlockedDomainController::class);

    /**
     * Content Sites
     */
    //Route::get('contentsites', 'ContentSiteController@index')->name('contentsites');
    Route::resource('contentsitedeliverysettings', ContentSiteDeliverySettingsController::class);
    Route::resource('espsettings', ESPSettingsController::class);
    Route::resource('datasource', DataSourceController::class);

    /**
     * Datasource Search
     */

    Route::get('datasource/{id}/search', 'DataSourceController@search')->name('datasource.search');
    Route::get('getdatasource/{id}/search', 'DataSourceController@getsearch');
    Route::post('postdatasource/{id}/search', 'DataSourceController@postsearch');

    /**
     * Datasource Analytics
     */

     Route::get('analytics/contact/search_list', 'DataSourceAnalyticsController@index')->name('analytics.contact');
     Route::get('analytics/contact/view_report/{id}', 'DataSourceAnalyticsController@show')->name('analytics.view');
     Route::get('analytics/contact/export_report/{id}', 'DataSourceAnalyticsController@exportCsv')->name('analytics.export');
     Route::delete('analytics/contact/delete_report/{id}', 'DataSourceAnalyticsController@destroy')->name('analytics.delete');

     /**
     * Datasource Outbound
     */
     Route::get('analytics/outbound', 'LeadsOutboundController@index')->name('analytics.outbound');

    /**
     * Content Verticals
     */
    //Route::get('contentsites', 'ContentSiteController@index')->name('contentsites');
    Route::resource('contentverticals', ContentVerticalsController::class);
    /**
     * Settings
     */
    ...
    Route::get('/unsubscribe', 'UnsubcribeUserController@index')->name('unsubscribe');

    Route::get('/unsubscribe/create', 'UnsubcribeUserController@create')->name('unsubscribe.create');

    Route::post('/unsubscribe/create', 'UnsubcribeUserController@store')->name('unsubscribe.store');

    Route::delete('/unsubscribe/delete/{email}/{osrc}', 'UnsubcribeUserController@delete')->name('unsubscribe.delete');

    /**
     * Ongage Stats
     */

     Route::get('ongage-stats', 'OngageStatsController@index')->name('ongagestats');
});
