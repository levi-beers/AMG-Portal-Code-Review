...
Route::apiResource('datasource2', 'DataSource2Controller');
Route::apiResource('datasource3', 'DataSource3Controller');
Route::apiResource('datasource4', 'DataSource4Controller');
Route::apiResource('datasource5', 'DataSource5Controller');
Route::apiResource('datasource6', 'DataSource6Controller');
Route::apiResource('datasource7', 'DataSource7Controller');
Route::apiResource('datajetbenefits', 'DataJetBenefitsController');
Route::apiResource('datajetsms', 'DataJetSMSController');
Route::apiResource('datasucohealth', 'DataSucoHealthController');
Route::apiResource('datasucoautoins', 'DataSucoAutoinsController');
Route::apiResource('datasucobathremodel', 'DataSucoBathremodelController');
Route::apiResource('datar1dmulti', 'DataR1DMultiController');
Route::apiResource('dataflex', 'DataFlexController');
Route::apiResource('datamarketbullet', 'DataMarketBulletController');
Route::apiResource('dataturtleleads', 'DataTurtleLeadsController');
Route::apiResource('datainterestmedia', 'DataInterestMediaController');
Route::apiResource('datalendmarx', 'DataLendmarxController');
Route::apiResource('datalendmarxsms', 'DataLendmarxSMSController');
Route::apiResource('databluemodomft', 'DataBlueModoMFTController');
Route::apiResource('databluemodomyhh', 'DataBlueModoMYHHController');
Route::apiResource('databluemodoloans', 'DataBlueModoLoansController');
Route::apiResource('dataimessage', 'DataiMessageController');
Route::apiResource('dataattribits', 'DataAttribitsController');
Route::apiResource('dataknresponders', 'DataKNRespondersController');
Route::apiResource('datajets2email', 'DataJetS2EmailController');
Route::apiResource('datajets2sms', 'DataJetS2SMSController');
Route::apiResource('datajets3', 'DataJetS3Controller');
Route::apiResource('databulldogsfeed1', 'DataBulldogsFeed1Controller');
Route::apiResource('datademoendpoint', 'DataDemoEndpointController');


Route::post('fetch-delivery-domains', 'BlockedDomainAPIController@fetchDeliveryDomains');
