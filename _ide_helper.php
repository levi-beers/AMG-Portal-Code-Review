    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \AMGPortal\Console\Kernel $instance */
...
namespace AMGPortal\Services\Auth\TwoFactor { 
    ...
    class Facade {
         ...
         *
         * @param \AMGPortal\Services\Auth\TwoFactor\TwoFactorAuthenticatable $user
         * @return bool 
         * @static 
         */ 
        public static function isEnabled($user)
        {
                        /** @var \AMGPortal\Services\Auth\TwoFactor\Authy $instance */
         ...
         *
         * @param \AMGPortal\Services\Auth\TwoFactor\Contracts\Authenticatable $user
         * @return mixed 
         * @static 
         */ 
    ...
    class JWTAuth {
        ...
        public static function attempt($credentials)
        {
            //Method inherited from \Tymon\JWTAuth\JWTAuth            
                        /** @var \AMGPortal\Services\Auth\Api\JWTAuth $instance */
         ...
         *
         * @param bool $forceForever
         * @return \AMGPortal\Services\Auth\Api\JWTAuth 
         * @static 
         */ 
...
namespace  { 
    ...
    class Authy extends \AMGPortal\Services\Auth\TwoFactor\Facade {}
