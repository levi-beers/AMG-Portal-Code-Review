...
@section('scripts')
    @if ($edit)
        {!! JsValidator::formRequest('AMGPortal\Http\Requests\Permission\UpdatePermissionRequest', '#permission-form') !!}
    @else
        {!! JsValidator::formRequest('AMGPortal\Http\Requests\Permission\CreatePermissionRequest', '#permission-form') !!}
    @endif
@stop
