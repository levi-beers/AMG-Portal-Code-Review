...
@include('partials.messages')
    ...
    <form action="{{ route('contentverticals.update',$contentvertical->id) }}" method="POST">
        @csrf
        @method('PUT')
         ...
         <div class="row mt-3">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <label for="vertical_name">Vertical Name</label>
                    <input type="text" name="vertical_name" value="{{ $contentvertical->vertical_name }}" class="form-control" placeholder="Vertical Name">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-floating">
                    <label for="vertical_description">Vertical Description</label>
                    <textarea class="form-control" placeholder="Enter a description for this vertical" name="vertical_description" id="vertical_description" style="height: 100px">{{ $contentvertical->vertical_description }}</textarea>
                </div>
            </div>
