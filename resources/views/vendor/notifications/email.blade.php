...
$style = [
    ...
    'email-wrapper' => 'width: 100%; margin: 0; padding: 0; background-color: #F2F4F6; border-top: 5px solid #2bc0ec;',
                    ...
                    <tr>
                        <td style="{{ $style['email-masthead'] }}">
                            <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
                                <img src="{{ url('assets/img/alchm.png') }}" alt="AMGPortal" height="120">
                                {{--{{ config('app.name') }}--}}
                            </a>
                        </td>
                    </tr>
