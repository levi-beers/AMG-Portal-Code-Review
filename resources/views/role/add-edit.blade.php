...
@section('scripts')
    @if ($edit)
        {!! JsValidator::formRequest('AMGPortal\Http\Requests\Role\UpdateRoleRequest', '#role-form') !!}
    @else
        {!! JsValidator::formRequest('AMGPortal\Http\Requests\Role\CreateRoleRequest', '#role-form') !!}
    @endif
@stop
