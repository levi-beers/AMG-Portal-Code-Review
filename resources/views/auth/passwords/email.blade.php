...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p">
    <div class="text-center">
        <img src="{{ url('assets/img/amgportal-logo.png') }}" alt="{{ setting('app_name') }}" height="50">
    </div>
...
@section('scripts')
    {!! JsValidator::formRequest('AMGPortal\Http\Requests\Auth\PasswordRemindRequest', '#remind-password-form') !!}
@stop
