...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p" id="login">
    <div class="text-center mt-5">
        <img src="{{ url('assets/img/amg-main2.png') }}" alt="{{ setting('app_name') }}" class="mt-5" width="100%" style="padding-top: 20px;">
    </div>

    <div class="card mt-5">
        <div class="card-body">
            <h3 class="card-title text-center mt-4 text-uppercase">
                @lang('Network Dashboard')
            </h3>
...
@section('scripts')
    ...
    {!! JsValidator::formRequest('AMGPortal\Http\Requests\Auth\LoginRequest', '#login-form') !!}
@stop
