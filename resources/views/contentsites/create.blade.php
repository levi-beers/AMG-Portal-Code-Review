...
<form action="{{ route('contentsites.store') }}" method="POST">
    @csrf
     ...
     <div class="row mt-4 mb-4">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="app_password" class="form-control" placeholder="Application Password">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Vertical ID:</strong>
                    {{ Form::select('vertical_id', $verticals, $options, ['class' => 'form-control']) }}
                </div>
            </div>
