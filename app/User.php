...
use AMGPortal\Presenters\Traits\Presentable;
use AMGPortal\Presenters\UserPresenter;
use AMGPortal\Services\Auth\TwoFactor\Authenticatable as TwoFactorAuthenticatable;
use AMGPortal\Services\Auth\TwoFactor\Contracts\Authenticatable as TwoFactorAuthenticatableContract;
use AMGPortal\Support\Authorization\AuthorizationUserTrait;
use AMGPortal\Support\CanImpersonateUsers;
...
class User extends Authenticatable implements TwoFactorAuthenticatableContract, MustVerifyEmail
{
    ...
    {
        Mail::to($this)->send(new \AMGPortal\Mail\ResetPassword($token));
