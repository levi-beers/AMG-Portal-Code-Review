...
use AMGPortal\Http\Requests\Data\CreateNewDataSucoBathremodelSubscriber;
use AMGPortal\Http\Resources\DataSucoBathremodelResource;
use AMGPortal\Http\Controllers\Controller;
use AMGPortal\DataSucoBathremodel;


class DataSucoBathremodelController extends Controller
{
     ...
     * @param CreateNewDataSucoBathremodelSubscriber $request
     * @return UserResource
     */
    public function store(CreateNewDataSucoBathremodelSubscriber $request)
    {
        //print "testtesttest";
        $data = $request->only([
...
//        ];
        ...
        $user = DataSucoBathremodel::create($data);

        return new DataSucoBathremodelResource($user);
