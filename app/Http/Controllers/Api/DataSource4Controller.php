...
use AMGPortal\Http\Requests\Data\CreateNewSubscriber4;
use AMGPortal\Http\Resources\DataResource4;
use AMGPortal\Http\Controllers\Controller;
use AMGPortal\DataSource4;


class DataSource4Controller extends Controller
{
     ...
     * @param CreateNewSubscriber4 $request
     * @return UserResource
     */
    public function store(CreateNewSubscriber4 $request)
    {
        //print "testtesttest";
        $data = $request->only([
...
//        ];
        ...
        $user = DataSource4::create($data);

        return new DataResource4($user);
    }
}
