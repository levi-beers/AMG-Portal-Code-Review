...
use AMGPortal\Http\Requests\Data\CreateNewDataLendmarxSMSSubscriber;
use AMGPortal\Http\Resources\DataLendmarxSMSResource;
use AMGPortal\Http\Controllers\Controller;
use AMGPortal\DataLendmarxSMS;

class DataLendmarxSMSController extends Controller
{
     ...
     * @param CreateNewDataLendmarxSMSSubscriber $request
     * @return UserResource
     */

    public function store(CreateNewDataLendmarxSMSSubscriber $request)
    {
        //print "testtesttest";
...
//        ];
        ...
        $user = DataLendmarxSMS::create($data);
        //error_log('Some message here.');
        //error_log(var_dump($user));

        return new DataLendmarxSMSResource($user);
