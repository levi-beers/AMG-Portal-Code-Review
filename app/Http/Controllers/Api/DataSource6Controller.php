...
use AMGPortal\Http\Requests\Data\CreateNewSubscriber6;
use AMGPortal\Http\Resources\DataResource6;
use AMGPortal\Http\Controllers\Controller;
use AMGPortal\DataSource6;


class DataSource6Controller extends Controller
{
     ...
     * @param CreateNewSubscriber6 $request
     * @return UserResource
     */
    public function store(CreateNewSubscriber6 $request)
    {
        //print "testtesttest";
        $data = $request->only([
...
//        ];
        ...
        $user = DataSource6::create($data);

        return new DataResource6($user);
    }
}
