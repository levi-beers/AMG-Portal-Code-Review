...
use AMGPortal\Http\Requests\Data\CreateNewSubscriber7;
use AMGPortal\Http\Resources\DataResource7;
use AMGPortal\Http\Controllers\Controller;
use AMGPortal\DataSource7;


class DataSource7Controller extends Controller
{
     ...
     * @param CreateNewSubscriber7 $request
     * @return UserResource
     */
    public function store(CreateNewSubscriber7 $request)
    {
        //print "testtesttest";
        $data = $request->only([
...
//        ];
        ...
        $user = DataSource7::create($data);

        return new DataResource7($user);
    }
}
