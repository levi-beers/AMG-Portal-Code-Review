...
use AMGPortal\Http\Requests\Data\CreateNewSubscriber5;
use AMGPortal\Http\Resources\DataResource5;
use AMGPortal\Http\Controllers\Controller;
use AMGPortal\DataSource5;


class DataSource5Controller extends Controller
{
     ...
     * @param CreateNewSubscriber5 $request
     * @return UserResource
     */
    public function store(CreateNewSubscriber5 $request)
    {
        //print "testtesttest";
        $data = $request->only([
...
//        ];
        ...
        $user = DataSource5::create($data);

        return new DataResource5($user);
    }
}
