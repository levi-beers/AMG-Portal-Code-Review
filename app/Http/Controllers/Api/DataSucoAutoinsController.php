...
use AMGPortal\Http\Requests\Data\CreateNewDataSucoAutoinsSubscriber;
use AMGPortal\Http\Resources\DataSucoAutoinsResource;
use AMGPortal\Http\Controllers\Controller;
use AMGPortal\DataSucoAutoins;


class DataSucoAutoinsController extends Controller
{
     ...
     * @param CreateNewDataSucoAutoinsSubscriber $request
     * @return UserResource
     */
    public function store(CreateNewDataSucoAutoinsSubscriber $request)
    {
        //print "testtesttest";
        $data = $request->only([
...
//        ];
        ...
        $user = DataSucoAutoins::create($data);

        return new DataSucoAutoinsResource($user);
