...
class EloquentRoleTest extends TestCase
{
    ...
    {
        $this->expectsEvents(\AMGPortal\Events\Role\Updated::class);
    ...
    {
        $this->expectsEvents(\AMGPortal\Events\Role\Deleted::class);
    ...
    {
        $role = Role::factory()->create();
        $permissions = \AMGPortal\Permission::factory()->times(2)->create();
